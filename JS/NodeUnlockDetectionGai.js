...
let result = {
    ...
    "YouTube": '<b>YouTube Pre&nbsp;： </b>检测失败，请重试',
}

let arrow = " ➟ "

Promise.all([ytbTest(),disneyLocation(),nfTest(),daznTest(),parmTest(),discoveryTest(),gptTest()]).then(value => {
    let content = "------------------------------------</br>"+([result["Dazn"],result["Netflix"],result["Disney"],result["Discovery"],result["Paramount"],result["YouTube"],result["ChatGPT"]]).join("</br></br>")
...
function disneyLocation() {
    return new Promise((resolve, reject) => {
        ...
        $httpClient.post(params, (errormsg,response,data) => {
            console.log("----------disney--------------");
            if (errormsg) {
                result["Disney"] = "<b>Disneyᐩ&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;：</b>检测失败";
            ...
            if (response.status == 200) {
                ...
                if (resData?.extensions?.sdk?.session != null) {
                    ...
                    if (inSupportedLocation == false) {
                        result["Disney"] = "<b>Disneyᐩ&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;：</b> 即将登陆 ➟ "+'⟦'+flags.get(countryCode.toUpperCase())+"⟧"
                        resolve();
                    } else {
    ...
    return new Promise((resolve, reject) => {
        ...
        $httpClient.get(params, (errormsg,response,data) => {
            ...
            if (errormsg) {
                ...
                result["YouTube"] = "<b>YouTube Pre&nbsp;： </b>检测失败";
                resolve(errormsg);
                return;
            }
            if (response.status !== 200) {
              ...
              if (data.indexOf('Premium is not available in your country') !== -1) {
                  result["YouTube"] = "<b>YouTube Pre&nbsp;： </b>未支持"
                  ...
                  result["YouTube"] = "<b>YouTube Pre&nbsp;： </b>支持 "+arrow+ "⟦"+flags.get(region.toUpperCase())+"⟧"
                  resolve(region);
              } else {
                result["YouTube"] = "<b>YouTube Pre&nbsp;： </b>检测超时";
                resolve("timeout");
              }
            }
        })
    ...
    return new Promise((resolve, reject) => {
        ...
        $httpClient.get(params, (errormsg,response,data) => {
            ...
            if (errormsg) {
                ...
                result["Paramountᐩ"] = "<b>Paramountᐩ&nbsp;&nbsp;&nbsp;： </b>检测失败";
                resolve(errormsg);
                return;
            }
            ...
            if (response.status == 200) {
                ...
                result["Paramount"] = "<b>Paramountᐩ&nbsp;&nbsp;&nbsp;： </b>检测失败";
                resolve();
            }
        })
    })
            ...
            if (response.status == 200) {
                ...
                $httpClient.get(p, (emsg, res, resData) => {
                    ...
                    if (emsg) {
                        ...
                        result["Discovery"] = "<b>Discoveryᐩ&nbsp;&nbsp;&nbsp;&nbsp;&thinsp;： </b>检测失败";
                        resolve(emsg);
                        return;
                    }
                    if (res.status == 200) {
                        ...
                        if (locationd == 'us') {
                            result["Discovery"] = "<b>Discoveryᐩ&nbsp;&nbsp;&nbsp;&nbsp;&thinsp;： </b>支持";
                            resolve();
                        } else {
                            result["Discovery"] = "<b>Discoveryᐩ&nbsp;&nbsp;&nbsp;&nbsp;&thinsp;： </b>未支持";
                            resolve();
                        }
                    } else {
                        result["Discovery"] = "<b>Discoveryᐩ&nbsp;&nbsp;&nbsp;&nbsp;&thinsp;： </b>检测失败";
                ...
                result["Discovery"] = "<b>Discoveryᐩ&nbsp;&nbsp;&nbsp;&nbsp;&thinsp;： </b>检测失败 ❗️";
                resolve(response.status);
            }
        })
    })
    ...
    return new Promise((resolve, reject) => {
        ...
        $httpClient.get(params, (errormsg,response,data) => {
            ...
            if (errormsg) {
                ...
                result["Netflix"] = "<b>Netflix&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;： </b>检测失败";
                resolve(errormsg);
                return;
            }
            ...
            if (jdg == -1) {
                ...
                $httpClient.get(p, (emsg, resheader, resData) => {
                    ...
                    if (emsg) {
                        ...
                        result["ChatGPT"] = "<b>ChatGPT&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;： </b>检测失败";
                        resolve(emsg);
                        return;
                    }
